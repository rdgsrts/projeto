...
<body>
    ...
    <div id="main" class="container">
        <h3 class="page-header">Alterar Filme</h3>
        <!-- Formulario para inclusao de clientes -->
        <form action="manterfilmes.do?id=${filme.id}" method="post">
            ...
            <div id="actions" class="row">
                <div class="col-md-12">
                    ...
                    <a href="manterfilmes.do?acao=listar" class="btn btn-default">Cancelar</a>
                </div>
            </div>
        </form>
    </div>
